import { LoadExternalReports, ResponseProps } from "./api/loadexternalreports";
...
import { description } from "./EAllReports.resources";
...
export default function EAllReports(props: AllReportsProps) {
  ...
  const handleLoadReports = async (auditid: string) => {
    ...
    const response: ResponseProps[] | any = await LoadExternalReports(data);
