...
import BalancedScorecard from "../../../Internal/components/IAudit/components/BalancedScorecard";
import { CustomButton } from "../../../../style/CustomButton";
import { CustomHr } from "../../../../style/CustomHr";
import Proof from "../../../Internal/components/IAudit/components/Proof";
import TableTr from "../../../Internal/components/IAudit/components/TableTr";
import { description } from "./ENewReport.resources";
...
export default function ENewReport(props: ReportStateProps) {
  ...
  const handleGenerateReport = async (auditid: string, email: string) => {
    let loading: AuditStateProps = {
      auditstate: "loading",
    };
    setauditState(loading);
    setloadingState(false);
    const data: ExternalReportProps = {
      auditid: auditid,
      email: email,
    };
    const response: ResponseProps | any = await generateExtReport(data);
  ...
  return (
    <React.Fragment>
      <CustomButton
        onClick={() => handleGenerateReport(props.auditid, props.email)}
      >
        {description.buttonreport}
      </CustomButton>
      <React.Fragment>
                ...
                {tableState !== undefined ? (
                  <BalancedScorecard
                    ...
                    dbversionReliability={
                      tableState.dbversion.cobit.Reliability
                    }
                    ...
                    userrightsCompliance={
                      tableState.userrights.cobit.Compliance
                    }
                    ...
                    passwordAvailability={
                      tableState.password.cobit.Availability
                    }
                    ...
                    reportcompany={props.companyname}
                  />
                ) : (
                  ""
                )}
