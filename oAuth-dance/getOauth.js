...
var AUTHORIZE_TOKEN_URL =
  jiraurl + "/plugins/servlet/oauth/authorize?oauth_token=";
...
function getAccessToken(oa, oauth_token, oauth_token_secret, pin) {
  oa.getOAuthAccessToken(
    ...
    function (error, oauth_access_token, oauth_access_token_secret, results2) {
      ...
      console.log(
        "Save these values and use them to authenticate your request.".bold
          .yellow
      );
      oa.get(
        jiraurl + "/rest/api/2/issue/" + issue,
        oauth_access_token,
